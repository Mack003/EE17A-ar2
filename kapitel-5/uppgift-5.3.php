...
if (strlen($epost) < 6) {
    echo "<p>Eposten är för kort. vg försök igen.</p>";
}

/* Kontrollera att epostadressen innehåller ett @, och minst en punkt. */
if (!strpos($epost, '@') ) {
    echo "<p>Eposten saknar @. vg försök igen.</p>";
}
if (!strpos($epost, '.') ) {
    echo "<p>Eposten saknar punkt. vg försök igen.</p>";
}

/* Rensa bort mellanslag i postnr */
